...
function getSourceAssetsPath() {
  ...
  if (typeof __filename !== "undefined") {
    ...
    currentFile = url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("index-BNpS0juA.js", document.baseURI).href);
  }
...
function copyDir(src, dest, transforms, callback) {
