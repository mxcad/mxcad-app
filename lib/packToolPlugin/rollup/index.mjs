...
import { r as resolveOptions, g as getSourceAssetsPath, a as getExternals, i as generateRuntimeConfigScript, c as copyDir, e as getContentType, b as createGlobalUniversalMiddleware, f as getApiMap } from "../index-B_FwBmgt.mjs";
    ...
    async writeBundle(options2, _bundle) {
      ...
      try {
        ...
        await new Promise((resolve2, reject) => {
          copyDir(sourceAssetsPath, outputDir, resolvedOptions, (err) => {
            if (err) reject(err);
            else resolve2();
          });
        });
