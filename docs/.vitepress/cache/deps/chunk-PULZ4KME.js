...
var p;
async function O() {
  const e = await import("./editor.main.d83c2780-2PYZUOYS.js").then((n) => n.e);
  ...
  `, "ts:vue"), await Promise.all([
    (async () => {
      const [
        ...
        import("./editor.worker.9c35f395-JEXDX2TD.js"),
        import("./html.worker.b57725c2-54BOTNM7.js"),
        import("./ts.worker.3260b66b-5HKRBO62.js")
      ]);
...
var M = function(e, n) {
  ...
  const r = defineAsyncComponent(() => import("./Demo.10a78ca5-OAKD4X4X.js"));
...
//# sourceMappingURL=chunk-PULZ4KME.js.map
