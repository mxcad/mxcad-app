 ...
 */
import { McDbPolyline, McDbHatch, MxCpp, McCmColor, McGePoint3d, McGeVector3d, McGePoint3dArray, McDbEntity } from 'mxcad';
...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		...
		// 绘制mxcad填充代码
		Drawing.prototype.drawMxcadHatch = function (oQRCode) {
			const entityArr = [];
			var _htOption = this._htOption;
